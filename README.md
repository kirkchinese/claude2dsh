...
- Full plugin-runtime compatibility and automatic conflict merging are roadmap goals; current synchronization is explicit tools plus the opt-in conflict-safe mirror.
